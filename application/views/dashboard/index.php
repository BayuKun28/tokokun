                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge" id="transaksi_bulan">0</div>
                ...
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge" id="stok_hari">0</div>
                                <div>Stok Masuk Hari Ini</div>
                            </div>
                        </div>
                    </div>
                    <a href="#">
                ...
                <div class="panel panel-yellow">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge" id="transaksi_hari">0</div>
...
<script>
    ...
    var transaksi_bulanUrl = '<?php echo site_url('transaksi/transaksi_bulan') ?>';
...
<script src="<?php echo base_url('assets/js/tokokun/dashboard.js') ?>"></script>
